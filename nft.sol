...
contract NicMeta is ERC721Enumerable, Ownable {
    ...
    bool public _revealed = false; // Hide Image

    // Constants
    uint256 public constant MAX_SUPPLY = 10; // Total Max amount of NFT
    uint256 public mintPrice = 0.3 ether; // Mint Price
    uint256 public maxBalance = 1; // Each Wallet limit
    uint256 public maxMint = 1; // Maximun Mint
